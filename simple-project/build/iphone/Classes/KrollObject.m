...
//@interface simple_projectObject : NSObject
//@end

@interface simple_projectObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[simple_projectObject class]])
		{
			for (NSString *key in [[(simple_projectObject*)o modules] allKeys])
			{
