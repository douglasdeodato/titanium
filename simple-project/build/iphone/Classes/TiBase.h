...
// in simulator we redefine to format for simple_project Developer console
...
{\
	NSString * exceptionName = [@"org.simple_project." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.simple_project";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIsimple_projectNativeItemNone = -1, 
	UIsimple_projectNativeItemSpinner = -2,
	UIsimple_projectNativeItemProgressBar = -3,
	
	UIsimple_projectNativeItemSlider = -4,
	UIsimple_projectNativeItemSwitch = -5,
	UIsimple_projectNativeItemMultiButton = -6,
	UIsimple_projectNativeItemSegmented = -7,
	
	UIsimple_projectNativeItemTextView = -8,
	UIsimple_projectNativeItemTextField = -9,
	UIsimple_projectNativeItemSearchBar = -10,
	
	UIsimple_projectNativeItemPicker = -11,
	UIsimple_projectNativeItemDatePicker = -12,
	
	UIsimple_projectNativeItemInfoLight = -13,
	UIsimple_projectNativeItemInfoDark = -14,
	
	UIsimple_projectNativeItemDisclosure = -15,
	
	UIsimple_projectNativeItemContactAdd = -16
};
